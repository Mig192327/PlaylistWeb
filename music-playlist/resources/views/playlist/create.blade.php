...
<head>
    ...
    <title>Adicionar Música - Playlist</title>
...
<body class="bg-gradient-to-tr from-purple-700 via-indigo-800 to-blue-900 min-h-screen flex flex-col items-center justify-center px-4">
    ...
    <div class="w-full max-w-md bg-white bg-opacity-90 backdrop-blur-md rounded-3xl shadow-2xl p-8">
        ...
        <form action="{{ route('playlist.store') }}" method="POST" class="space-y-6" novalidate>
            @csrf
            ...
            <div class="relative input-with-icon">
                ...
                <input type="text" name="nm_musica" id="nm_musica" value="{{ old('nm_musica') }}" required
            ...
            <div class="relative input-with-icon">
                ...
                <input type="text" name="artista" id="artista" value="{{ old('artista') }}" required
            ...
            <div class="relative input-with-icon">
                ...
                <input type="text" name="gravadora" id="gravadora" value="{{ old('gravadora') }}" required
            ...
            <button type="submit"
                ...
                active:scale-95 transform transition duration-200 shadow-lg focus:outline-none focus:ring-4 focus:ring-indigo-400">
                Adicionar Música
            </button>
        </form>
    </div>
